<template>
  <main>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <TitleComponent title="Everything You Love About Coffee" />
    ...
    <section class="best" id="best" ref="best">
      <div class="container">
        <div class="title">Our best</div>
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <div class="best__wrapper">
              <ProductCard v-for="card in bestsellers" :key="card.id" classItem="best__item" :card="card" />
            </div>
          </div>
        </div>
      </div>
